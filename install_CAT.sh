...
echo ""
echo "****************** Installing tensorboard ******************"
# TensorBoard UI for logs; used by torch.utils.tensorboard SummaryWriter and tensorboard CLI.
...
# Tensor rearrangement ops used heavily in transformer-style code (rearrange/reduce).
