...
cfg.PEFT = edict()
cfg.PEFT.lora_class = 'hydra'
cfg.PEFT.reweight = True
cfg.PEFT.task_weight = True
cfg.PEFT.dim = 128
...
cfg.DATA.TEMPLATE.mask_ratio = 0

# TEST
cfg.TEST = edict()
cfg.TEST.TEMPLATE_FACTOR = 3.0
cfg.TEST.TEMPLATE_SIZE = 128
# cfg.TEST.SEARCH_FACTOR = 6.0
cfg.TEST.SEARCH_SIZE_s1 = 320
cfg.TEST.SEARCH_SIZE_s2 = 320
cfg.TEST.SEARCH_FACTOR_s2 = 4.0
cfg.TEST.EPOCH = 500
